...
def main():
    ...
    st.image("![project_image](https://github.com/user-attachments/assets/2f465da0-7a56-4753-afb3-65d62dbed03c)", caption="Image Classification Project", use_column_width=True)
    st.write("""
        ## Project Overview
