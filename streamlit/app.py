...
def main():
    ...
    st.image("![project_image](https://github.com/user-attachments/assets/9073678f-3699-4455-a446-9c8604261538)", caption="Image Classification Project", use_column_width=True)
    st.write("""
        ## Project Overview
